 ...
 * Aufgabe 2 ��� Haustiere
 ...
 // und die Anzahl der Tage hochgez��hlt, die der Vorrat reicht.
 ...
 Leiten Sie von der abstrakten Klasse Haustiere die Klassen Hund und Katze ab. Schreiben Sie f��r 
 beide Subklassen einen Konstruktor, der den Konstruktor der Superklasse aufruft. Implementieren 
 Sie anschlie��end in den Subklassen die abstrakten Methoden:
 ...
 Testen Sie das Programm in einer Klasse HaustierFuettern. Die Ausgabe sieht dann ungef��hr wie 
 folgt aus:
...
Die Klasse Hund bekommt zusätzlich eine Instanzvariable kategorie(Typ String). Es wird 
3 Kategorien geben:
...
Erweitern Sie die Konstruktoren der Subklassen um eine int-Variable, über die die 
Instanzvariablen kategorie bzw. haltung entsprechend initialisiert werden.

Überschreiben Sie in den Subklassen die Methode anzeigen() der Superklasse. Sie soll 
zusätzlich die Kategorie bzw. den Typ der Haltung ausgeben.

Testen Sie das Programm in einer Klasse HaustierFuettern. Die Ausgabe sieht dann ungefähr 
wie diese aus:
