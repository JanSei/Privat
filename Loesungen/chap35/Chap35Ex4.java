...
class Vorratskammer
{
  ...
  public void gemischteFruechte()
  {
    ...
    {
      ausgeben();
      unzenGesamt = glas1.getMenge() +
                    glas2.getMenge() +
                    glas3.getMenge() ;

      Marmelade mixed = new Marmelade
        ("Gemischte Fruechte", "19.01.11", unzenGesamt);
...
public class Chap35Ex4
{
  public static void main(String[] args)
  {
    Marmelade stachelbeer = new Marmelade("Stachelbeer", "04.07.09", 4);
    Marmelade erdbeer     = new Marmelade("Erdbeer", "30.09.10", 3);
    Marmelade aprikosen   = new Marmelade("Aprikosen", "31.10.10", 5);

    Vorratskammer vorrat  =
      new Vorratskammer(stachelbeer, erdbeer, aprikosen);
